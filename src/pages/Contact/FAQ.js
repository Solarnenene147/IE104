      ...
      <div className='grid-container-faq'>
        <div>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Việc ủng hộ cho các dự án thiện nguyện trên GiveHub.vn tuyệt đối an toàn, tiền ủng hộ được thanh toán qua các cổng thanh toán uy tín như Viettel Pay, VnPay,..và tới trực tiếp tài khoản của các Tổ chức gây quỹ có tư cách pháp nhân, GiveHub chỉ ghi nhận và minh bạch hóa các thông tin.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                GiveHub hợp tác với các đối tác trung gian thanh toán và tích hợp đa dạng các phương thức thanh toán khác nhau để thuận tiện nhất cho người ủng hộ, bạn có thể lựa chọn bất cứ phương thức thanh toán nào phù hợp nhất với mình. Các phương thức thanh toán bao gồm:<br /><br />
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                GiveHub không thu bất cứ khoản phí nào từ người ủng hộ. Người ủng hộ chỉ mất phí tiện ích/ phí dịch vụ (phí chuyển tiền thông thường) cho các nền tảng trung gian thanh toán được quy định bởi các bên:<br /><br />
                ...
                <li className='ml-3'>Thẻ nội địa/tài khoản ngân hàng/ví điện tử: Miễn phí dịch vụ 01 (một) năm kể từ 17/1/2022 (Kết thúc thời gian trên, GiveHub sẽ cập nhật mức phí do VnPay áp dụng);</li><br />
                <li className='ml-3'>Thẻ quốc tế: 1.7% giá trị Giao dịch CTT + 2.200VND/Giao dịch CTT.</li><br /><br />

                GiveHub nỗ lực hợp tác để mức phí này là nhỏ nhất so với mức phí chuyển tiền thông thường. Trong một số giai đoạn, phí chuyển tiền được các đối tác cổng thanh toán tài trợ miễn phí.<br />
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Ngay sau khi chuyển tiền ủng hộ thành công cho một dự án thông qua các nền tảng thanh toán tích hợp trên GiveHub.vn, bạn sẽ thấy khoản ủng hộ của mình trong mục Danh sách ủng hộ của Dự án mà bạn chọn, bao gồm: Tên người ủng hộ (do bạn nhập thông tin) + Số tiền ủng hộ + Thời gian ủng hộ. Toàn bộ số tiền ủng hộ của bạn được chuyển thẳng tới tài khoản của Tổ chức gây quỹ mà không qua bên thứ ba nào khác.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Ngoài ghi nhận đóng góp bằng tiền, GiveHub cho phép người dùng đóng góp bằng công sức thông qua chức năng Sứ giả truyền thông gây quỹ và ghi nhận các thông tin cần thiết một cách minh bạch. Hoặc bạn cũng có thể sử dụng nút chia sẻ để lan tỏa dự án thiện nguyện tới bạn bè của mình trên các mạng xã hội.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Bạn có thể ủng hộ cho các Dự án gây quỹ trên GiveHub.vn mà không cần phải đăng ký làm thành viên của GiveHub. Tuy nhiên việc đăng ký sẽ giúp bạn tương tác và cập nhật tốt hơn các thông tin về dự án và tổ chức mà bạn quan tâm, ủng hộ.
              </Typography>
            </AccordionDetails>
          </Accordion>
        ...
        <div>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                GiveHub là một nền tảng hỗ trợ các hoạt động mang lại lợi ích cho cộng đồng và xã hội, các dự án khởi chạy trên GiveHub phải được thực hiện bởi các tổ chức có chức năng gây quỹ và tiếp nhận tài trợ nhằm mục tiêu phục vụ cho các hoạt động từ thiện, xã hội và môi trường, theo tôn chỉ, mục đích của tổ chức mình và theo quy định của pháp luật.<br /><br />

                Để được khởi tạo dự án gây quỹ trên GiveHub.vn, tổ chức cần ký hợp đồng sử dụng nền tảng công nghệ thông tin với GiveHub và hợp đồng sử dụng cổng thanh toán với các đối tác trung gian thanh toán của GiveHub
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                GiveHub là nền tảng cho phép các Tổ chức gây quỹ chủ động khởi tạo các dự án trên GiveHub.vn, các tổ chức có thể tự tạo dự án với các mục tiêu về thời gian gây quỹ, số tiền gây quỹ, nội dung và các thông tin liên quan.<br /><br />
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Các dự án gây quỹ trên GiveHub.vn được đề nghị gây quỹ không quá 60 ngày/dự án, để đảm bảo việc tập trung và truyền thông cho dự án. Tùy từng trường hợp, thời gian gây quỹ có thể được kéo dài.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Nền tảng GiveHub tự động cập nhật các tình trạng cho nhà tài trợ và các sứ giả gây quỹ hay những người quan tâm tới dự án của tổ chức, khi dự án hoàn thành gây quỹ, kết thúc thời gian gây quỹ, nhập các báo cáo triển khai, giai ngân.<br /><br />

                GiveHub hướng tới phát triển thêm các tính năng như xuất hóa đơn/phiếu thu điện tử cho Người ủng hộ, Gửi Cerificate cho người ủng hộ,…
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Các khoản ủng hộ thông qua GiveHub sẽ được chuyển thẳng tới Tài khoản ngân hàng của các Tổ chức gây quỹ trong thời gian T+1 kể từ thời điểm người ủng hộ chuyển tiền.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Bạn có thể ghi lại thông tin người ủng hộ và thay mặt họ thực hiện việc ủng hộ thông qua GiveHub.vn để cập nhật danh sách người ủng hộ lên trang dự án.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Dự án sẽ tự động kết thúc khi hết thời gian gây quỹ hoặc số tiền gây quỹ đạt được mục tiêu. Trong trường hợp khác, bạn vui lòng liên hệ GiveHub để được hỗ trợ.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Bạn hoàn toàn có thể và GiveHub khuyến khích bạn chia sẻ và lan tỏa Dự án của mình tới bạn bè thông qua Facebook để đạt hiệu quả gây quỹ cao hơn. Biểu tượng chia sẻ được gắn ở mỗi dự án cụ thể.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>
